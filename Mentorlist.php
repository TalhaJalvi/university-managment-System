     ...
     if (move_uploaded_file($tempname, $folder))  { 
            ...
            //If connection building is failed to database
             echo "Connection to DBMS failed";
               ...
               $query1="DELETE FROM  `mentorlist` WHERE `id`='$idvar'";
              ...
              //Now sending pdf details in database
               ...
               $query2="INSERT INTO `mentorlist` (`address`, `date`) VALUES ( '$folder','$date')";
				...
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="Mentorlist.php">Mentorlist</a></li>
