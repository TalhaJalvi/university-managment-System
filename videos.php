...
<body>
	...
	<!-- /.navbar -->
		...
		<header id="head" class="secondary">
            <div class="container">
                    <h1>Online Videos</h1>
                    <p>Online Videos for the help and betterment of our students.</p>
                </div>
    </header>
		...
		<div class="row">
			<div class="col-md-12">
				<section id="portfolio" class="page-section section appear clearfix">
					...
					<br />
					<p>
						Everyone can see it clearly. Everyone can listen and understand clearly. If can't understand then can make the videos back for understanding again. Clears doubts of every students. Very interactive as well as useful. Makes classes interesting to study. Provides test for better knowledge of that chapter. Provides also a lot of questions to make you understand
					<br />
						<br />
					</p>
