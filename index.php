...
<br>
	...
	<header id="head">
		<div class="container">
             <div class="heading-text">							
							<h1 class="animated flipInY delay1">SEGi E-Services</h1>
							<p>An online (e-services) platform for SEGians to access in the system whenever they want</p>
						</div>
    ...
    <div class="row">
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							...
							<h4>Meet and Greet with Staff</h4>
							<p>Comming Soom</p>
						</div><!--grey box -->
					</div><!--/span3-->
					<div class="col-md-3">
      ...
      <div class="row">
        ...
        <p><span>SEGi University and Colleges first opened its doors as Systematic College in 1977 in the heart of Kuala Lumpur’s commercial district, offering globally recognised professional qualifications. Since then, SEGi has experienced significant growth by adapting and catering to an increasing demand for tertiary education and professional qualifications in Malaysia. Known as one of the largest private higher education providers in Malaysia, SEGi now serves 25,000 students in five major campuses located in Kota Damansara, Kuala Lumpur, Subang Jaya, Penang and Sarawak..</span></p>
        <p>Today, the significance of climbing the career ladder in the industry is highly competitive, therefore SEGi now offers a new breakthrough method known as PACE or Professional and Continuing Education. </p><p>SEGi PACE enables working adults to upgrade their qualification level whilst accommodating their work schedule, hence fulfilling work-life balance</p>
  ...
  <div class="footerbottom">
    ...
    <div class="col-md-3 col-sm-6"> 
            	<div class="footerwidget"> 
                         <h4>Contact</h4> 
                        <p>SEGi University Kota Damansara</p>
            <div class="contact-info"> 
            <i class="fa fa-map-marker"></i>Malaysia<br>
            <i class="fa fa-phone"></i>+0000000000 <br>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 panel">
						<div class="panel-body">
							<p class="text-right">
								Copyright &copy; 2021 <a href="#" rel="develop">JALVITHEDEVELOPER</a>
							</p>
						</div>
					</div>
