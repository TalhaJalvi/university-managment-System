            ...
            //If connection building is failed to database
             echo "Connection to DBMS failed";
              ...
              //Now sending pdf details in database
               $query="INSERT INTO `studentdocket` (`sregno`, `address`) VALUES ('$regno', ' $folder')";
               $run=mysqli_query($conn,$query);
               if($run==true){
                ?>
                <script type="text/javascript">
                  alert("Exam Docket was successfully uploaded")
                </script>
                <?php
               }
               else{
                alert("Failed to upload Exam Docket");
               }
          ...
          <li ><a href="studentresult.php">Student Results</a></li>
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="progressionplan.php">Progression plan</a></li>
               <li class="active"><a href="examdocket.php">Exam Docket</a></li>
            </ul>
          </li>
          <li class="dropdown">
