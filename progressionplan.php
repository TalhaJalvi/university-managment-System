            ...
            //If connection building is failed to database
             echo "Connection to DBMS failed";
               ...
               //Before sending data to database deleting old time table
                ...
                $query0="SELECT * FROM `progressionplan`";
               ...
               $query1="DELETE FROM  `progressionplan` WHERE `id`='$idvar'";
              ...
              //Now sending pdf details in database
               ...
               $query2="INSERT INTO `progressionplan` (`address`, `date`) VALUES ( '$folder','$date')";
				...
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="progressionplan.php">Progression plan</a></li>
